...
const base={deposited:10000,remaining:10566,overCeiling:0,suggestedMonthlyToYearEnd:1761,currentMonthlyDeposit:0,suggestedTotalMonthlyToYearEnd:1761};
...
test('המלצה חודשית מציגה תוספת וסכום הוראת קבע כולל',()=>{
  const copy=buildRecommendation({...base,suggestedMonthlyToYearEnd:514,currentMonthlyDeposit:500,suggestedTotalMonthlyToYearEnd:1014},{fundStatus:'liquid',completionPreference:'monthly'});
  assert.match(copy,/514/); assert.match(copy,/1,014/);
});
